  ...
  return (
    <div className="pt-10 text-left flex flex-col xl:w-2/12 bg-white text-black h-screen p-4">
      ...
      >
        <NavLink
          to="/admin" 
          className={` flex items-center p-2 rounded-lg ${isReservationsActive ? 'bg-indigo-200' : 'bg-slate-200 hover:bg-slate-300'}`}
        >
        ...
        <NavLink
          to="/admin/cafes" 
          className={`flex items-center p-2 rounded-lg ${isCafesActive ? 'bg-indigo-200' : 'bg-slate-200 hover:bg-slate-300'}`}
        >
        ...
        <NavLink
          to="/" 
          className={`flex items-center p-2 rounded-lg ${isLogoutActive ? 'bg-indigo-200' : 'bg-slate-200 hover:bg-slate-300'}`}
        >
